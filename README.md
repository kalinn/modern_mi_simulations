...
Outline of steps to reproduce the results:
1) Run the scripts in folder `data_generation` to create full plasmode simulation datasets and datasets with MCAR, MAR, and two types of MNAR missingness.
