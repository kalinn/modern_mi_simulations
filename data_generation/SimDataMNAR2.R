...
b0 = c (-38.96479, -36.74732, -35.10863)

# Magic intercepts for rowwise missingness proportions
# in var1 and var2 to be 10/30/50%
b0var1 = c (-38.68708, -37.30622, -36.44142)
b0var2 = c (-72.32039, -49.20354, -38.26461)
...
for (w in 1:3) {
  ...
  genDat <- function (k){
    ...
    wdatNA <- select(wdat, -event, -hazard, -time, -reth_black, -reth_hisp, -reth_oth, -site_ureter, -site_renal, -site_urethra, -treat, -b.ecogvalue, -var1, -var2, -zeta)
